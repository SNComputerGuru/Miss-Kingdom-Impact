...
// .wrangler/tmp/pages-BXPzMR/functionsWorker-0.8570769694682852.mjs
...
__name(buildParamString, "buildParamString");
__name2(buildParamString, "buildParamString");
async function generateSignature(data, passphrase) {
  const encoder = new TextEncoder();
  const stringToSign = passphrase ? `${buildParamString(data)}&passphrase=${encodeURIComponent(passphrase)}` : buildParamString(data);
...
async function onRequest(context) {
  ...
  try {
    ...
    const formInputs = Object.entries(payload).map(([key, value]) => {
...
// .wrangler/tmp/bundle-XdsS1z/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-XdsS1z/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8570769694682852.js.map
